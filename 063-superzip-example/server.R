...
function(input, output, session) {
  ...
  output$map <- renderLeaflet({
    leaflet() %>%
      addTiles(
        urlTemplate = "//{s}.tile.thunderforest.com/landscape/{z}/{x}/{y}.png?apikey=<pk.eyJ1IjoicmNobGVlIiwiYSI6ImNqODNpNjN3NTk0aTEzM25wc2FhOGVtc3IifQ.7xPKsXkDV9yjwPtf9zn06g'>",
